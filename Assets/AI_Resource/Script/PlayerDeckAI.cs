...
<<<<<<< HEAD
	...
	void InitializeDeckFromSavedDeck()
	{
		...
		{
			Debug.LogError("Battle�J�n���Ƀf�b�L���I������Ă��܂���I");
			return;
		}
		...
		if (!File.Exists(path))
		{
			Debug.LogError("�f�b�L�t�@�C�������݂��܂���: " + path);
			return;
		}
		...
		Debug.Log($"Battle�p�f�b�L�ǂݍ��ݐ���: {data.deckName}");

		// �C cardIds ������40���f�b�L����
		foreach (int id in data.cardIds)
		{
			// DeckEdit����int�ACardAI����string�Ȃ̂ŕϊ�����
			...
			if (cardData == null)
			{
				Debug.LogWarning($"�J�[�hID��allCards�ɑ��݂��܂���: {idString}");
				continue;
			}
